...
print("Function 2b: ", function_2b.__doc__)
print("Function 2c: ", function_2c.__doc__)

var_1 = function_2c(1000, 1, 1, -50)["add"]

var_2 = function_2b("Seminars", "Borrel")["C"]

var_3 = str(function_2c(1, 1000, 10, 1)["multiply"]) + function_2b("CLS", "Borrel")["L"]
