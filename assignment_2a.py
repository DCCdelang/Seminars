...
""""
Functions 2b and 2c were swapped in this file to make more sense of the output
given the documentation and the expected output
...
var_3 = str(function_2c(5, 10, 1000, -50)['multiply']) + str(function_2b("cls","")['C'])
